...
//		}
		...
		// TODO
//		String[] welcomleList = StringUtil.split(env.getProperty("app.web.welcomeFileList"), ",");
//		if (welcomleList != null && welcomleList.length > 0) {
////			/index.html;JSESSIONID=xxxxx?x1=1&x2=2  => /;JSESSIONID=xxxxx?x1=1&x2=2
//		}
