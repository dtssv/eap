...
//	}
	...
	public boolean isFormTokenEnable() {
		return Boolean.parseBoolean(this.getProperty("app.web.form.token.enable", "false"));
	}
	...
	public String getDomain() {
		return this.getProperty("app.web.domain", "_");
	}
	...
	public Map<String, String> getDomainUrls() {
		...
		Map<String, Object> domains = filterForPrefix("app.web.domain.");
		for (Map.Entry<String, Object> domain : domains.entrySet()) {
			urlMap.put(domain.getKey(), (domain.getValue() != null ? domain.getValue().toString() : ""));
		}
		return urlMap;
	}
