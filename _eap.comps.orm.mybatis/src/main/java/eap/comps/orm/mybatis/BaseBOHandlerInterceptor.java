			...
			if (SqlCommandType.INSERT.equals(sqlCommandType)) {
				...
				if (currUserDetailsVO != null) {
					if (baseBO.getCreatedBy() == null) {
						baseBO.setCreatedBy(currUserDetailsVO.getUserId());
					}
					if (currUserDetailsVO instanceof EnterpriseUserDetailsVO) {
						...
						if (baseBO.getDeptCode() == null) {
							baseBO.setDeptCode(currEnterpriseUserDetailsVO.getDeptCode());
						}
						if (baseBO.getOrgCode() == null) {
							baseBO.setOrgCode(currEnterpriseUserDetailsVO.getOrgCode());
						}
					}
				}
				...
				if (currUserDetailsVO != null) {
					if (baseBO.getUpdateBy() == null) {
						baseBO.setUpdateBy(currUserDetailsVO.getUserId());
					}
				}
				if (baseBO.getUpdateTime() == null) {
					baseBO.setUpdateTime(DateUtil.currDate());
