...
public class ValidationUtil {
	...
	public static final Pattern MOBILE_NUMBER_PATTERN = Pattern.compile("^1[0-9]{10}$");
...
//				}
	...
	public static boolean isBankCardNumber(String value) {
		if(value == null || value.length() < 15 || value.length() > 19 || !isNumber(value)){
			return false;
		}
...
//		System.out.println(isBankCardNumber("4060328636837506"));
		
		System.out.println(isValidID("34240119780823082X"));//34240119780823082X"));
